...
sub generateXML($) {
    ...
    $writer->startTag('testsuites', "error"=>"0", "failures"=>"0", "name"=>$PROJECT_NAME, "skipped"=>"0", "tests"=>"1", "time"=>"");
    $writer->startTag('testsuite', "error"=>"0", "failures"=>"0", "hostname"=>"Donau", "id"=>"0", "name"=>$PRODUCT_TESTED_ON, "package"=>$PACKAGE_NAME, "skipped"=>"0", "tests"=>$case_num, "time"=>"", "timestamp"=>"2016-02-16T02:50:00");
