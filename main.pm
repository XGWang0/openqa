...
sub load_virtauto_tests() {
	#loadtest "virttest/init_pxe_install.pm";
        #load_inst_tests();
	loadtest "virttest/preparation/login_console.pm";
	#loadtest "virttest/preparation/install_package.pm";
	loadtest "virttest/prj1_guest_installation/guest_installation_on_" . get_var("HOST_PRD") . ".pm";
